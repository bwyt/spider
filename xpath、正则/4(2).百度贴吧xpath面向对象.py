...
class Spider:
    ...
    def parse_list_page(self,data):
        ...
        # 提取详情页url
        lis = element.xpath('//*[@id="thread_list"]/li')
        detail_url_list = []
        for li in lis:
            if li.xpath('.//a[@class="j_th_tit "]/@href')[0]:
                url ='http://tieba.baidu.com' + li.xpath('.//a[@class="j_th_tit "]/@href')[0]
                detail_url_list.append(url)
        # 获取下一页的url
        next_url = 'http:'+element.xpath('//a[text()="下一页>"]/@href')[0]
    ...
    def parse_detail_page(self,url):
        ...
        element = html.fromstring(data)
        image_url_list = element.xpath('//cc//img[@class="BDE_Image"]/@src')
